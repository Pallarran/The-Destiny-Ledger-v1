...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default: "bg-ink text-panel hover:bg-ink/90",
        destructive: "bg-danger text-panel hover:bg-danger/90",
        outline: "border border-border bg-transparent hover:bg-panel/10",
        secondary: "bg-muted text-panel hover:bg-muted/80",
        ghost: "hover:bg-panel/10",
        gold: "bg-gold text-ink hover:bg-gold/90",
        accent: "bg-accent text-ink hover:bg-accent/90 glow"
      },
      size: {
