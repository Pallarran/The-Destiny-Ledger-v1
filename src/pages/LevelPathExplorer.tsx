...
export function LevelPathExplorer() {
  ...
  return (
    <div className="space-y-6">
      {/* Visual Header */}
      <div className="relative h-32 rounded-lg overflow-hidden bg-gradient-to-br from-blue-900 via-purple-900 to-indigo-900 shadow-xl">
        ...
        <div className="relative z-10 h-full flex items-center px-8">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-3xl font-bold text-white">Level Path Explorer</h1>
              <p className="text-white/80 text-sm mt-1">
                Find the optimal leveling sequence to reach your target build
              </p>
            </div>
          </div>
        </div>
